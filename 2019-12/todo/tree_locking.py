...
# Implement locking in a binary tree. A binary tree node can 
# be locked or unlocked only if all of its descendants or 
...
# be locked, then it should return false. Otherwise, 
